  ...
  return (
    <div className="menu-container">
      ...
      <div className="menus">
        <ul>
          <li>
            <Link  to={"/"} onClick={()=> handleMenuClick(0)} style={{textDecoration: "none"}}> <p className={selectedMenu === 0 ? activeMenuClass : menuClass}>Dashboard</p></Link>
        ...
        <div className="profile" onClick={()=> handleProfileClick() } >
         ...
         <Link to={"/Auth"}> <p className="username">USERID</p> </Link>
        </div>
      </div>
    </div>
  );
